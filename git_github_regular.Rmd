...
[1] Scott Chamberlain (2018). ghql: General Purpose GraphQL Client. R package
  version 0.0.4.9210. https://github.com/ropensci/ghql

[2] Rich FitzJohn, Jeroen Ooms, Scott Chamberlain and Stefan Milton Bache
  (2017). jqr: Client for 'jq', a 'JSON' Processor. R package version
  1.0.0. https://CRAN.R-project.org/package=jqr
  
[3] Maëlle Salmon and Scott Chamberlain (2018). ghrecipes: Provides some helper
  functions for using the GitHub V4 API. R package version 0.1.0. https://github.com/ropenscilabs/ghrecipes
  
[4] Widgren, S., et al. (2018) git2r: Provides Access to Git Repositories. R
  package version 0.21.0. URL https://CRAN.R-project.org/package=git2r.
  
[5] Lorenz Walthert (2018). gitsum: Parse and summarize git repositories. R
  package version 0.0.9001.
  
[6] Bob Rudis and Al Danial (2018). cloc: Count Lines of Code, Comments and
  Whitespace in Source Files and Archives. R package version 0.1.0.

[7] Silge J and Robinson D (2016). “tidytext: Text Mining and Analysis Using
Tidy Data Principles in R.” _JOSS_, *1*(3). doi: 10.21105/joss.00037 (URL:
http://doi.org/10.21105/joss.00037), <URL:
http://dx.doi.org/10.21105/joss.00037>.

[8] Rinker, T. W. (2018). sentimentr: Calculate Text Polarity Sentiment
